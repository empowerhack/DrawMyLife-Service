class HxlstatsController < ApplicationController
  ...
  def show 
    ...
    @hxlstatsgroups.each do | keys, hxlstatsgroup | 
      ...
      @hxlstatsgroupsgender = hxlstatsgroup.group_by { |hxlstat| hxlstat.gender }
      ...
      @hxlstatsgroupsage = hxlstatsgroup.group_by { |hxlstat| hxlstat.age }
      ...
      @hxlstatsgroupsage.each do | k_age, v_age | 
        ...
        if k_age < 5
          younger_than_five += 1
        elsif k_age >= 5 and k_age < 13
          five_twelve_total += 1
        elsif k_age >= 13 and k_age <= 18
      ...
      @results.append( [*keys, hxlstatsgroup.count, gender_totals[0], gender_totals[1], gender_totals[2], five_twelve_total, thirteen_eighteen_total, younger_than_five, older_total]  )
    end
